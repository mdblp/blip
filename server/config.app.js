...
const config = {
  ...
  INVITE_KEY: stringOption(process.env.INVITE_KEY, ''),
  LATEST_TERMS: stringOption(process.env.LATEST_TERMS, null),
  ...
  CAN_SEE_PWD_LOGIN: booleanFromText(process.env.CAN_SEE_PWD_LOGIN, true),
  SUPPORT_EMAIL_ADDRESS: stringOption(process.env.SUPPORT_EMAIL_ADDRESS, ''),
  SUPPORT_WEB_ADDRESS: stringOption(process.env.SUPPORT_WEB_ADDRESS, ''),
  REGULATORY_WEB_ADDRESS: stringOption(process.env.REGULATORY_WEB_ADDRESS, ''),
  HELP_LINK: stringOption(process.env.HELP_LINK, null),
  ASSETS_URL: stringOption(process.env.ASSETS_URL, 'https://url.com/'),
