    ...
    if (this.props.sent) {
      ...
      content = (
        <div className="EmailVerification-intro">
          <div className="EmailVerification-title">{t('Keeping your data private and secure is important to us!')}</div>
          <div className="EmailVerification-instructions">
            <p>{t('We just sent you an email. To verify we have the right email address, please click the link in the email to activate your account.')}</p>
          </div>
        </div>
      );
    }
