...
const config = {
  ...
  SUPPORT_EMAIL_ADDRESS: __SUPPORT_EMAIL_ADDRESS__ || 'yourloops@diabeloop.com',
  SUPPORT_WEB_ADDRESS: __SUPPORT_WEB_ADDRESS__ || 'https://support.diabeloop.com/hc/categories/360001386093-YourLoops',
