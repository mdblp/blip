...
- YLP-4044 Display the prefix "Android" or "iOS" before the OS release version
...
- YLP-4115 Display the OS release version
...
- YLP-2480 Care team settings UI - Info section
...
- YLP-2464 Adapt graph and statistics values according to patient profile of the patient
...
- YLP-3591 Change mention "Data calculated on the last 14 days"
